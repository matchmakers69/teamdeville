...
const EngineItems = ({
  ...
  useEffect(() => {
    const fetchImages = async () => {
      try {
        const resPhotos = await fetchEnginePhotos(featured_media);
...
EngineItems.propTypes = {
  handleOpenPopUp: PropTypes.func.isRequired,
  index: PropTypes.number.isRequired,
};
export default withToast(connect()(EngineItems));
